...
#align(center)[
  ...
  #text(size: 14pt)[Midterm#lecture_num]
...
#underline[*Data Processing*]\
*Imputation*
- Column transformer
  - binary_transformer = OneHotEncoder(drop="if_binary",dtype=int)
  - ordinal_transformer = OrdinalEncoder(categories=[level],dtype=int)

\
#underline[*Classification Models*] \
- k-NN
  -
- Support Vector Classifier (SVC/SVM)
  - Determines the geometric relationship between datapoints in the training set by finding the vectors that are close to the decision boundary (i.e. where the target variable changes for the data points).
  - Curved decision boundary, non-linear
